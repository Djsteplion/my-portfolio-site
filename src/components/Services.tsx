...
function ServiceCard({ icon, title, description }: { icon: string; title: string; description: string }) {
  ...
  return (
    <div
      ref={ref}
      className="reveal flex h-[380px] w-[300px] md:h-[320px] md:w-[360px] flex-col items-center rounded-xl bg-[var(--text-main)] p-10 text-center shadow-[0px_10px_30px_rgba(0,0,0,0.1)] max-[1024px]:w-[500px] max-[700px]:w-[250px]"
    >
